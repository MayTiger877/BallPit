...
public:
    ...
    bool isRotary() const noexcept
    {
        return style == Rotary
            ...
            || style == MayT_DirectionKnob
            || style == MayT_PhaseKnob
            || style == MayT_VariationKnob
            || style == MayT_VelocityKnob
            || style == MayT_TempoKnob;
    }
    ...
    void showPopupMenu()
    {
        ...
        if (isRotary())
        {
            ...
            rotaryMenu.addItem (6, TRANS("Use left-right/up-down dragging"), true, style == MayT_DirectionKnob);
            rotaryMenu.addItem (7, TRANS("Use left-right/up-down dragging"), true, style == MayT_PhaseKnob);
            rotaryMenu.addItem (8, TRANS("Use left-right/up-down dragging"), true, style == MayT_VariationKnob);
            rotaryMenu.addItem (9, TRANS("Use left-right/up-down dragging"), true, style == MayT_VelocityKnob);
            rotaryMenu.addItem (10, TRANS("Use left-right/up-down dragging"), true, style == MayT_TempoKnob);
    ...
    static void sliderMenuCallback (int result, Slider* slider)
    {
        if (slider != nullptr)
        {
            switch (result)
            {
                ...
                case 6:   slider->setSliderStyle(MayT_DirectionKnob); break;
                case 7:   slider->setSliderStyle(MayT_PhaseKnob); break;
                case 8:   slider->setSliderStyle(MayT_VariationKnob); break;
                case 9:   slider->setSliderStyle(MayT_VelocityKnob); break;
                case 10:   slider->setSliderStyle(MayT_TempoKnob); break;
